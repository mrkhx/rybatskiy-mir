namespace RybatskiyMir.World
{
    ...
    public static class QualityTier
    {
        ...
        public static float FogStart => Current == QualityLevel.Low ? 22f : 42f;
        public static float FogEnd => Current == QualityLevel.Low ? 80f : Current == QualityLevel.Medium ? 130f : 180f;
        public static float FogDensity => Current == QualityLevel.Low ? 0.016f : 0.0085f;
        public static float ViewDistance => Current == QualityLevel.Low ? 110 : Current == QualityLevel.Medium ? 180 : 280;
    }
}
