...
| Бег | **Shift** | LB |
| Сесть на мостик | **E** | South |
| Заброс / подсечка | **ЛКМ** или Пробел | South |
| Подмотка | Shift | RT |
| Встать / отпустить | Esc | East |

Курсор в Play Mode захватывается. Alt+Tab, чтобы выйти.

Цикл: подойти к старому мостику → E → прицел/сила (W/S) → ЛКМ заброс → ждать поклёвку → ЛКМ подсечка → вываживание → ЛКМ в садок / Esc отпустить.
